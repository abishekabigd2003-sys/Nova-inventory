...
$CatBody = @{ name = "Test Category 3 $Rand"; description = 'A test category' }
...
$ProdBody = @{ name = "Test Product 3 $Rand"; sku = "TST-003-$Rand"; categoryId = $CatId; price = 100; description = 'A test product' }
